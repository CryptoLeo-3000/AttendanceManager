...
<html lang = "eng">
	...
	<style>
        ...
        margin: 0px;
        padding: 0px;
        background: url(https://i.imgur.com/9YjVSL5.png);
        ...
        <div class="container-fluid">
            <table>
                ...
                <?php        
                    ...
                    $student_no = filter_input(INPUT_POST, 'student_no');
                    $sql = "SELECT s.*, t.time, t.date FROM student s inner join time t on s.student_no = t.student_no where s.student_no = '$student_no'";
